const javascript=["/web/javascript/AES和Base64加解密.md","/web/javascript/JS事件循环机制.md","/web/javascript/JavaScript浮点数运算的精度问题.md","/web/javascript/VUE首屏加载速度优化.md","/web/javascript/base64转二进制数组ArrayBuffer.md","/web/javascript/byte转换.md","/web/javascript/common.js.md","/web/javascript/js常用函数.md","/web/javascript/vscode调试.md","/web/javascript/关于this.md","/web/javascript/实现一个深克隆.md","/web/javascript/获取页面元素宽高.md","/web/javascript/视频播放相关.md"]
...
const vue=["/web/vue/VUE实现局部刷新.md","/web/vue/VUE笔记.md","/web/vue/i18n.md","/web/vue/svg在vue中以及在vux组件库中的使用.md","/web/vue/vue-element-admin.md","/web/vue/vue中引入第三方库.md","/web/vue/vue中路由跳转query与params.md","/web/vue/vue定义全局方法.md","/web/vue/实现一个极简版的双向绑定.md","/web/vue/项目部署多环境.md"]
const others=["/web/others/__dirname.md","/web/others/flutter父子组件通信.md","/web/others/github表情.md","/web/others/h5与原生app交互的原理.md","/web/others/resolve.md","/web/others/vscode同步设置.md","/web/others/wepy子组件未更新的问题.md","/web/others/技巧.md","/web/others/钉钉手机网页应用更改标题栏.md","/web/others/需要调用钉钉的api时如何调试页面.md","/web/others/骚操作.md"]
...
const utils=["/utils/utils/windows磁盘检测.md","/utils/utils/使用spark-md5对文件进行加密.md","/utils/utils/依赖库.md"]
const article=["/article/article/你在遗憾什么.md","/article/article/劝学.md","/article/article/北冥有鱼.md","/article/article/呐喊.md","/article/article/如是我闻.md","/article/article/师说.md","/article/article/心经.md","/article/article/热风.md","/article/article/琵琶行.md","/article/article/生于忧患，死于安乐.md","/article/article/送东阳马生序.md","/article/article/金刚经.md","/article/article/陋室铭.md"]
